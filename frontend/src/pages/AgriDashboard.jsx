  ...
  const dashboardCards = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-12 h-12 text-gray-700 group-hover:text-black transition-colors duration-300">
    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-50 to-white p-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <header className="text-center mb-12 pt-6">
          ...
          <div 
            className={`mt-6 inline-flex items-center bg-white border border-gray-200 rounded-full px-4 py-2 text-gray-900 shadow-md transition-all duration-700 ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {dashboardCards.map((card, index) => (
            <div 
              key={card.id}
              className="group bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center transition-all duration-500 hover:bg-gray-50 hover:border-black cursor-pointer relative shadow-md hover:shadow-xl hover:-translate-y-1 overflow-hidden"
              onMouseEnter={() => {
            ...
            >
              <div 
                className="absolute inset-0 bg-gray-100 opacity-0 group-hover:opacity-30 transition-opacity duration-500 rounded-full scale-0 group-hover:scale-150"
                style={{
              ...
              <div className="w-16 h-16 mb-4 flex items-center justify-center relative">
                {card.icon}
                <svg 
                  className="absolute inset-0 w-full h-full text-gray-400 opacity-0 group-hover:opacity-20 transition-all duration-700 transform rotate-0 group-hover:rotate-180" 
                  viewBox="0 0 100 100"
                >
              ...
              <h3 className="font-bold text-lg text-center text-gray-900 group-hover:text-black transition-colors duration-300 mb-2">{card.title}</h3>
              
              <p className="text-gray-600 text-sm text-center mt-1 transition-all duration-500 max-h-0 group-hover:max-h-20 opacity-0 group-hover:opacity-100 overflow-hidden">
                {card.description}
              </p>
              ...
              <div className="mt-4 w-full opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
                <button className="w-full py-1 px-3 bg-black text-white text-sm rounded transition-all duration-300 hover:bg-gray-800 flex items-center justify-center">
                  <span>Open</span>

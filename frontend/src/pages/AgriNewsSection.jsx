...
const AgriNewsSection = () => {
  ...
  return (
    <div id="news-section" className="relative py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-6xl mx-auto px-4">
        <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h3 className="text-gray-600 font-semibold mb-2 tracking-wider uppercase">
            FROM THE BLOG
          </h3>
          <h2 className="text-4xl font-bold text-gray-900 mb-4 relative inline-block">
            News & Articles
            <span className="absolute -bottom-2 left-0 h-1 w-full bg-black"></span>
          </h2>
        </div>
            ...
            >
              <div className="relative overflow-hidden h-56">
                ...
                <div className="absolute bottom-4 left-4">
                  <div className="bg-black text-white px-3 py-1 text-sm font-medium rounded">
                    {article.date}
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-white">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-800 hover:text-black transition-colors duration-300">
                  {article.title}
                </h3>
              </div>
            </div>

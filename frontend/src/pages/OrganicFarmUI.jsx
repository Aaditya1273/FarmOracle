...
const OrganicFarmUI = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen w-full p-4 md:p-8 flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-16 -left-16 w-64 h-64 bg-gray-200 rounded-full opacity-10 blur-3xl"></div>
        <div className="absolute top-1/2 -right-32 w-96 h-96 bg-gray-300 rounded-full opacity-10 blur-3xl"></div>
      </div>
      ...
      <div className="max-w-5xl w-full p-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <div 
              className="bg-black text-white rounded-lg p-4 mt-4 border border-gray-200 flex items-center gap-3 max-w-xs transform hover:scale-105 transition-all duration-300 shadow-lg"
              style={{ 
            ...
            >
              <div className="bg-gray-200 rounded-full p-2 flex items-center justify-center animate-pulse">
          ...
          <div 
            className="md:w-1/2 text-gray-900"
            style={{ 
              transform: isVisible ? 'translateX(0)' : 'translateX(50px)',
              opacity: isVisible ? 1 : 0,
          ...
          >
            <div 
              className="text-gray-600 mb-2 uppercase tracking-wide font-medium relative overflow-hidden inline-block"
              style={{ 
            ...
            >
              ...
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-black transform translate-x-full transition-transform duration-500"></span>
            </div>
            ...
            >
              <span className="inline-block hover:text-gray-700 transition-colors duration-300">Pure Agriculture and</span><br />
              <span className="inline-block hover:text-gray-700 transition-colors duration-300">Organic Form</span>
            </h1>
            
            <h3 
              className="text-gray-700 text-xl font-medium mb-4 transform hover:translate-x-1 transition-transform duration-300"
              style={{ 
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  <div className={`bg-black rounded-full p-1 w-6 h-6 flex items-center justify-center mt-1 transition-transform duration-300 ${activeFeature === index ? 'scale-125' : ''}`}>
            ...
            >
              <button className="bg-black text-white font-bold py-3 px-6 rounded-md hover:bg-gray-800 transition-all duration-300 flex items-center gap-2 relative overflow-hidden group shadow-lg hover:shadow-xl">
